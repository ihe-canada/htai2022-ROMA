...
matplot(ceac[1:n.wtp,], type = 'l',
        ...
        col= c("black","blue3"),
        lwd = 3)
legend("topright", strategy, col= c("black","blue3"),lty = 1:4, bty = "n")
...
save.image(file = "HTAi2022ToyMarkov.RData")
